...
#pragma acc data create(T_new[0:ROWS+2][0:COLS+2],T_old[0:ROWS+2][0:COLS+2])
	{
...
#pragma acc kernels present (T_new,T_old)
			for (i=1 ; i <=ROWS; i++){
				for(j=1; j <=COLS; j++){
...
#pragma acc kernels
	...
	}// end of scope of data construct
